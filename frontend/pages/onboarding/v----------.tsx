...
function VerifyPhone() {
  ...
  return (
    ...
    <OnboardingLayout title="Verify phone" description={`Enter the SMS code sent to your number. Expires in ${mm}:${ss}.`} stepIndex={7} totalSteps={18} onBack={() => router.push(-1)}>
