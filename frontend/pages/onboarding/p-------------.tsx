...
import { Button, HTMLInputElement, Input, Label, OnboardingLayout } from 'lucide-react';
...
function ProofOfAddress() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    router.push("/onboarding/phone-status");
  };

  return (
    <OnboardingLayout title="Proof of address" description="Upload a PDF/JPG/PNG showing your name, address, and date." stepIndex={14} totalSteps={18} onBack={() => router.push(-1)}>
