...
function PhoneStatus() {
  ...
  return (
    <OnboardingLayout title="Phone verification" description="WeÃ¢â‚¬â„¢ll auto-complete this if you verified less than 24 hours ago." stepIndex={15} totalSteps={18} onBack={() => router.push(-1)}>
