...
function PhoneStatus() {
  ...
  return (
    <OnboardingLayout title="Phone verification" description="WeÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ll auto-complete this if you verified less than 24 hours ago." stepIndex={15} totalSteps={18} onBack={() => router.push(-1)}>
