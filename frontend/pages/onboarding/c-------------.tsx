...
import { Contact, OnboardingLayout } from 'lucide-react';
...
function ContactDetails() {
  ...
  return (
    ...
    <OnboardingLayout title="Contact details" description="Tell us how to reach you." stepIndex={6} totalSteps={18} onBack={() => router.push(-1)}>
